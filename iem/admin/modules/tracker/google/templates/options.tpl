...
<div id="module_tracker_google" class="Module_Tracker_Options">
	<div>
		<label class="customCheckBox" for="module_tracker_google_use">
	...
	<div class="customRow optionPadding Module_Tracker_Google_Options" style="display: none;">
			<div style="padding:.5rem 0px;">{$HTML.Required} %%LNG_MODULE_Tracker_Google_CampaignNameExplain%%:</div>
		<input type="text" name="module_tracker_google_options_name" id="module_tracker_google_options_name" value="" class="form-control Field350"/>
		%%LNG_HLP_MODULE_Tracker_Google_CampaignName%%
	</div>
	<div class="customRow optionPadding Module_Tracker_Google_Options" style="display: none;">
		<div style="padding:.5rem 0px;">{$HTML.Required}%%LNG_MODULE_Tracker_Google_SourceNameExplain%%:</div>
		<input type="text" name="module_tracker_google_options_source" id="module_tracker_google_options_source" value="%%LNG_MODULE_Tracker_Google_DefaultSourceName%%" class="form-control Field350"/>
