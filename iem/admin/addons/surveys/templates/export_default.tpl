            ...
            <ul>
                ...
                <li>
                    <div class="formButtons">
                        <button class="FormButtonSurvey SaveAddButton btn save-btn SubmitButton" type="submit">{$lang.Addon_Surveys_exportResponsesDownload}</button>
...
{else}
    ...
    color:#000000;'>
        ...
        <tr><td class="body"><input type="submit" name="Action" value="%%LNG_Addon_surveys_Create%%" class=" createSurveyButton btn save-btn" style="width:16rem" onclick="location.href = 'index.php?Page=Addons&Addon=surveys&&Action=Create'; return false;"></td></tr>
    </table>
{/if}
<style>
*{
