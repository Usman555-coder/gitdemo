...
<?php
            ...
            default:
                ...
                if (count($lists) == 1) {
                    ...
                    //var_dump($this->ChooseList('add', 'step2')); exit;
                }
                break;
        }
    }
                ...
                switch ($customfield_info['fieldtype']) {
                    ...
                    case 'radiobutton':
                        ...
                        foreach ($fieldsettings['Key'] as $pos => $key) {
                            ...
                            $optionlist .= '<label class="customRadio" style="margin-right: 5px;" for="' . $label_id . '"><input style="margin-right:4px" type="radio" id="' . $label_id . '" name="CustomFields[' . $customfield_info['fieldid'] . ']" value="' . htmlspecialchars($key, ENT_QUOTES, SENDSTUDIO_CHARSET) . '"' . $selected . '>' . htmlspecialchars($fieldsettings['Value'][$pos], ENT_QUOTES, SENDSTUDIO_CHARSET) . '<span class="checkmarkRadio"></span></label>';
                            if ($c % 4 == 0) {
                                $optionlist .= '<br/>';
                            }
                            $c++;
                    ...
                    case 'checkbox':
                        ...
                        foreach ($fieldsettings['Key'] as $pos => $key) {
                            ...
                            $optionlist .= '<label class="customCheckBox" style="margin-right: 5px;" for="' . $label . '"><input class="checkbox" style="margin-right: 4px; " type="checkbox" name="CustomFields[' . $customfield_info['fieldid'] . '][' . $pos . ']" id="' . $label . '" value="' . htmlspecialchars($key, ENT_QUOTES, SENDSTUDIO_CHARSET) . '"' . $checked . '> ' . htmlspecialchars($fieldsettings['Value'][$pos], ENT_QUOTES, SENDSTUDIO_CHARSET) . ' <span class="checkmark"></span></label>';
