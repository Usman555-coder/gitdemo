    ...
    private function ManageLists($param)
    {
        ...
        foreach ($mylists as $pos => $listinfo) {
            ...
            if ($listinfo['ownerid'] == $user->userid || $user->HasAccess('Lists', 'Edit', $listinfo['listid'])) {
                ...
                $GLOBALS['ListAction'] .= '<span class="dropdown-item">' . $this->DisabledItem('Edit') . '</span>';
            }
            ...
            if ($create_list === true) {
                ...
                $GLOBALS['ListAction'] .= '<span class="dropdown-item">' . $this->DisabledItem('Copy', $itemtitle) . '</span>';
            }
            ...
            if ($listinfo['ownerid'] == $user->userid || $user->HasAccess('Lists', 'Delete', $listinfo['listid'])) {
                ...
                $GLOBALS['ListAction'] .= '<span class="dropdown-item">' . $this->DisabledItem('Delete') . '</span>';
            }
