		...
		if (isset($_POST['what'])) {
			...
			switch (strtolower($what)) {
				...
				case 'imagemanagermanage':
					...
					$GLOBALS['ImageManager_AddButton'] = '<input id="btnUpload" type="button" value="'.GetLang('ImageManagerUploadImages').'" class="SmallButton btn save-btn" />';
					...
					$GLOBALS['ImageManager_DeleteButton'] = '<input id="deleteButton" type="button" value="'.GetLang('DeleteSelected').'"  class="SmallButton btn save-btn" style="'.$showDeleteBtn.';" />';
