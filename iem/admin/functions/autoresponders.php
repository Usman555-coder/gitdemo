	...
	function ManageAutoresponders($listid=0)
	{
		...
		foreach ($myautoresponders as $pos => $autoresponderdetails) {
			...
			if ($autoresponderdetails['pause'] == 0) {
				$GLOBALS['AutoresponderAction']  = '<a class="dropdown-item" href="index.php?Page=Autoresponders&Action=Pause&id=' . $autoresponderid . '&list=' . $listid . '">' . GetLang('Pause') . '</a>';
			} else {
				$GLOBALS['AutoresponderAction']  = '<a class="dropdown-item" href="index.php?Page=Autoresponders&Action=Resume&id=' . $autoresponderid . '&list=' . $listid . '">' . GetLang('Resume') . '</a>';
			}

			$GLOBALS['AutoresponderAction']  .= '<a class="dropdown-item" href="index.php?Page=Autoresponders&Action=View&id=' . $autoresponderid . '" target="_blank">' . GetLang('View') . '</a>';

			if ($user->HasAccess('Autoresponders', 'Edit')) {
				$GLOBALS['AutoresponderAction'] .= '<a class="dropdown-item" href="index.php?Page=Autoresponders&Action=Edit&id=' . $autoresponderid . '&list=' . $listid . '">' . GetLang('Edit') . '</a>';
			} else {
				$GLOBALS['AutoresponderAction'] .= $this->DisabledItem('Edit');
			}

			if ($user->HasAccess('Autoresponders', 'Create')) {
				$GLOBALS['AutoresponderAction'] .= '<a class="dropdown-item" href="index.php?Page=Autoresponders&Action=Copy&id=' . $autoresponderid . '&list=' . $listid . '">' . GetLang('Copy') . '</a>';
			} else {
				$GLOBALS['AutoresponderAction'] .= $this->DisabledItem('Copy');
			}

			if ($user->HasAccess('Autoresponders', 'Delete')) {
				$GLOBALS['AutoresponderAction'] .= '<a class="dropdown-item" href="javascript:ConfirmDelete(' . $autoresponderid . ');">' . GetLang('Delete') . '</a>';
			} else {
