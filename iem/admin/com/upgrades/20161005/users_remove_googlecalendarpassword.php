...
* @package SendStudio
*/
class users_remove_googlecalendarpassword extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if (!$this->ColumnExists('users', 'googlecalendarpassword')) {
			return true;
		}
		$query = 'ALTER TABLE ' . SENDSTUDIO_TABLEPREFIX . 'users DROP googlecalendarpassword';
