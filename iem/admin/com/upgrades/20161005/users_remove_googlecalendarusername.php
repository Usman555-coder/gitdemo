...
* @package SendStudio
*/
class users_remove_googlecalendarusername extends Upgrade_API
{
	/**
	* RunUpgrade
	...
	*/
	function RunUpgrade()
	{
		if (!$this->ColumnExists('users', 'googlecalendarusername')) {
			return true;
		}
		$query = 'ALTER TABLE ' . SENDSTUDIO_TABLEPREFIX . 'users DROP googlecalendarusername';
