...
class IEM_InterspireTemplate extends InterspireTemplate {
    ...
    public function ParseTemplate($name = null, $return = false, $input = null) {
        ...
        if ($parseTemplateFile) {
            if ($this->EventBeforeUncachedTemplateParsed()) {
                ...
                //var_dump($this->TemplateData); exit;
                ...
                //var_dump(SendStudio_Functions::GenerateMenuLinksPagewise()); exit;
    ...
    private function IEM_Menu() {
        ...
        if (!IEM::sessionGet('LicenseError')) {
            ...
            $nav_menus = SendStudio_Functions::GenerateMenuLinksPagewise();
        }
        ...
        if (!$unlimited_total_emails) {
            ...
            $GLOBALS['TotalEmailCredits'] = sprintf(GetLang('User_Total_CreditsLeft'), $ssf->FormatNumber($creditLeft));
        }
        ...
        if (!$unlimited_monthly_emails) {
            ...
            $GLOBALS['MonthlyEmailCredits'] = sprintf(GetLang('User_Monthly_CreditsLeft'), $ssf->FormatNumber($creditLeft), $ssf->FormatNumber($user->group->limit_emailspermonth));
            if (!$unlimited_total_emails) {
                $GLOBALS['MonthlyEmailCredits'] .= '&nbsp;&nbsp;|';
            }
        }
    ...
    public function ParseHelpLanguageVariables() {
        ...
        foreach ($matches[1] as $index => $value) {
            $helpTip = "<span class=\"HelpToolTip\">"
                    . '<img src="assets/images/infoIconBlue.svg" alt="?" width="24" height="16" border="0" />'
