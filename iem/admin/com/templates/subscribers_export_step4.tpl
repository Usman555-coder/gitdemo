<script>
    $(function () {
        $('input#startExportSubscriber').click(function (event) {
            tb_show('', 'index.php?Page=Subscribers&Action=Export&SubAction=ExportIFrame&keepThis=true&TB_iframe=tue&height=360&width=450&modal=true', '');
    ...
    <tr>
        <td class="body pageinfo internalAnchor">
            <p class="PageIntroP">
                ...
                <hr>
                <input id="startExportSubscriber" type="button" value="%%LNG_ExportStart%%" class="FormButton_wide SaveAddButton btn save-btn" style="margin-top: 5px;"/>
            </p>
        </td>
    </tr>
</table>
