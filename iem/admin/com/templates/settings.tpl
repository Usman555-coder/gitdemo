...
<script>
    $(function () {
        ...
        $(document.settings.allow_attachments).click(function () {
            $('#ShowAttachmentSize').toggle();
        });

        $(document.settings.allow_embedimages).click(function () {
            $('#ShowDefaultEmbeddedImages')[this.checked ? 'show' : 'hide' ]();
        });
        ...
        $(document.settings.cron_enabled).click(function () {
            $('.CronInfo', document.settings)[this.checked ? 'show' : 'hide']();
        });

        $(document.settings.security_wrong_login_wait_enable).click(function () {
            $('tr.security_wrong_login_wait_options').toggle();
        });
        $(document.settings.security_wrong_login_threshold_enable).click(function () {
            $('tr.security_wrong_login_threshold_options').toggle();
        });

        $(document.settings.credit_warnings).click(function () {
            $('div#credit_percentage_warnings_options', document.settings)[this.checked ? 'show' : 'hide']();
        });
        ...
        $('input.OnFocusSelect, textarea.OnFocusSelect', document.settings).focus(function () {
            this.select();
        });
    });
        ...
        <tr>
            <td>
                <div>
                    <br/>
                    <ul id="tabnav">
                        <li><a href="index.php?Page=Settings&Tab=1" {if $ShowTab == 1}class="active"{/if} id="tab1" onclick="ShowTab(1);
                                $('#id_tab_num').val(1);
                                return false;"><span>{$lang.ApplicationSettings_Heading}</span></a></li>
                        <li><a href="index.php?Page=Settings&Tab=2" {if $ShowTab == 2}class="active"{/if} id="tab2" onclick="ShowTab(2);
                                $('#id_tab_num').val(2);
                                return false;"><span>{$lang.EmailSettings_Heading}</span></a></li>
                        ...
                        <li><a href="index.php?Page=Settings&Tab=3" {if $ShowTab == 3}class="active"{/if} id="tab3" onclick="ShowTab(3);
                                $('#id_tab_num').val(3);
                                return false;"><span>{$lang.CreditSettings_Heading}</span></a></li>
                        <li><a href="index.php?Page=Settings&Tab=4" {if $ShowTab == 4}class="active"{/if} id="tab4" onclick="ShowTab(4);
                                $('#id_tab_num').val(4);
                                return false;"><span>{$lang.CronSettings_Heading}</span></a></li>
                        {if $DisplayPrivateLabel}<li><a href="index.php?Page=Settings&Tab=8" {if $ShowTab == 8}class="active"{/if} id="tab8" onclick="ShowTab(8);
                                $('#id_tab_num').val(8);
                                return false;"><span>{$lang.PrivateLabelSettings_Heading}</span></a></li>{/if}
                            <li><a href="index.php?Page=Settings&Tab=5" {if $ShowTab == 5}class="active"{/if} id="tab5" onclick="ShowTab(5);
                                    $('#id_tab_num').val(5);
                                    return false;"><span>{$lang.SecuritySettings_Heading}</span></a></li>
                            <li><a href="index.php?Page=Settings&Tab=6" {if $ShowTab == 6}class="active"{/if} id="tab6" onclick="ShowTab(6);
                                    $('#id_tab_num').val(6);
                                    return false;"><span>{$lang.AddonsSettings_Heading}</span></a></li>
                        </ul>
