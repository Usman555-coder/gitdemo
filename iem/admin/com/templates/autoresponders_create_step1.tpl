                ...
                <table border="0" cellspacing="0" cellpadding="2" width="100%" class="Panel" style="margin-top:10px ; border-bottom:0px">
                    ...
                    <tr class="whiteBackground">
                        ...
                        <td style="font-family: 'Roboto', Arial, Tahoma, sans-serif; color: #000; font-size:14px ; padding-top: 1.35rem;  color: #000;" class="multiselectTd">
                            <select name="list" style="height:200px; font-size:14px" multiple class="scroll1 ISSelectDiv" size="15" onDblClick="CheckForm() && this.form.submit()">
                                %%GLOBAL_SelectList%%
                            </select>
                ...
                <table width="100%" cellspacing="0" cellpadding="2" border="0" class="PanelPlain nextCancelButton">
                    <tr>
                        ...
                        <td valign="top" height="30">
                            ...
                            <input class="FormButton CancelButton btn cancel-btn" value="%%LNG_Cancel%%" onClick='if (confirm("%%GLOBAL_CancelButton%%")) {
                                        document.location = "index.php?Page=Autoresponders"
                                    }' />
                        </td>
                    </tr>
                </table>
