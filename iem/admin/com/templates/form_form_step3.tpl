    ...
    <table cellspacing="0" cellpadding="0" width="100%" align="center">
        ...
        <tr>
            <td>
                ...
                <input class="FormButton" type="button" value="%%LNG_Cancel%%" onClick='if (confirm("%%GLOBAL_CancelButton%%")) {
                            ...
                            <table width="100%" border="0">
                                <tr>
                                    <td width="20" valign="top">
                                        <input onClick="document.getElementById('errorurlField').style.display = 'none';
                                                document.getElementById('errorhtmlField').style.display = '';" id="errorhtmlRadio" name="userrorhtmlurl" value="0" type="radio"%%GLOBAL_ErrorPageHTMLField%%>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td width="20">
                                        <input onClick="document.getElementById('errorurlField').style.display = '';
                                                document.getElementById('errorhtmlField').style.display = 'none';
                                                $('#errorpageurl').focus();" id="errorurlRadio" name="userrorhtmlurl" value="1" type="radio"%%GLOBAL_ErrorPageUrlField%%>
                                    </td>
                                    <td>
