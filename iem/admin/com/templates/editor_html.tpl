...
<tr id="htmlCF">
    ...
    <td>
        <input type="button" onclick="javascript: ShowCustomFields('html', 'myDevEditControl', '%%PAGE%%');
                return false;" value="%%LNG_ShowCustomFields%%..." class="FormButton btnsstylse btn" style="width: 140px;" />
        <input type="button" onclick="javascript: InsertUnsubscribeLink('html');
