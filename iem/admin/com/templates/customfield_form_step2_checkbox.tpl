...
<tr class="whiteBackground">
    ...
    <td style="font-family: 'Roboto', Arial, Tahoma, sans-serif; color: #000; font-size:14px ; padding-top: 1.35rem;  color: #000;">
        <textarea type="text" name="MultiValues" id="MultiValues" class="form-control Field350" style="width:450px; height:200px">%%GLOBAL_CurrentList%%</textarea>
        <div class="aside" style="font-family: 'Roboto', Arial, Tahoma, sans-serif; color: #000;font-size: 14px;padding-top: 1.35rem;">%%LNG_CustomField_Checkbox_Hint%%</div>
