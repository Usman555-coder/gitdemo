    ...
    <table cellspacing="0" cellpadding="0" width="100%" align="center">
        ...
        <tr>
            <td>
                ...
                <input class="FormButton" type="button" value="%%LNG_Cancel%%" onClick='if (confirm("%%LNG_Subscribers_Edit_CancelPrompt%%")) {
                            document.location = "index.php?Page=Subscribers&Action=Manage&SubAction=Step3&List=%%GLOBAL_list%%"
                        }'>
                <br />
                &nbsp;
