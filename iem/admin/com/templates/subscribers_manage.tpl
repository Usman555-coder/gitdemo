...
<table cellspacing="0" cellpadding="0" width="100%" align="center">
    <tr>
        <td class="headingSearch">
            <div style="margin: 10px 5px 0 0; float: right;">
                <div style="text-align: left;">
                    <form name="ActionSearchContacts" method="post" action="index.php?Page=Subscribers&Action=Manage&SubAction=SimpleSearch%%GLOBAL_URLQueryString%%">
                        ...
                        <input type="image" border="0" src="images/search.svg" id="SearchButton" style="vertical-align: top; padding-top: 11px;" name="SearchButton" />
                    </form>
            ...
            <div class="Heading1 col-sm-6 Heading1New" style="margin-top:14px;display: flex;
            align-items: center;">
                %%LNG_View%%:
                <a href="#" style="text-decoration: none;" id="SubscriberViewPickerButton" class="PopDownMenu_Resize">
                    <span id="SubscriberViewPicker_Caption" class="Heading1New" style="color: #279ccb;">%%GLOBAL_SubscribersManage%%</span>
            ...
            <form name="ActionMembersForm" method="post" action="index.php?Page=Subscribers&Action=Manage&SubAction=Change&List=%%GLOBAL_List%%" onsubmit="return ConfirmChanges();">
                <table width="100%" border="0" style="margin-top:25px ;">
                    <tr>
                        ...
                        <input  class="customButtonLink" style="background: #fff;" type="button" name="cmdAddContact" value="%%LNG_Subscribers_Add_Button%%"  /></td>
                    </tr>
                    <tr>
                        <td valign="bottom">
                ...
                <div class="thirdPartyTable">   
                 <table border="0" cellspacing="0" cellpadding="0" style="margin-top:25px;" class="table" id="SubscribersManageList">
                    <tr class="Heading3">
...
#SubscriberViewPicker_MenuContainer b {
