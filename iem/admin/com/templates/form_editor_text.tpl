<table border="0" cellspacing="0" cellpadding="2">
    ...
    <tr style="display: %%GLOBAL_ShowCustomFields%%">
        <td>
            <input type="button" onclick="javascript: ShowCustomFields('TextContent');
                    return false;" class="SmallButton" style="width:140px" value="%%LNG_InsertACustomField%%" />
            <input type="button" onclick="javascript: InsertUnsubscribeLink('TextContent');
                    return false;" class="SmallButton" style="width:140px" value="%%LNG_InsertUnsubscribeLink%%" />
