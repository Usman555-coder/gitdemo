    ...
    <table cellspacing="0" cellpadding="0" width="100%" align="center">
        ...
        <tr>
            <td>
                ...
                <input class="FormButton" type="button" value="%%LNG_Cancel%%" onClick='if (confirm("%%LNG_ScheduleEditCancel_Prompt%%")) {
                ...
                <table border="0" cellspacing="0" cellpadding="2" width="100%" class="Panel">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" onclick="javascript: PreparePreview();
                                    return false;"><img src="images/magnify.gif" border="0">&nbsp;%%LNG_Preview%%</a>
                        </td>
                    </tr>
                    <tr>
