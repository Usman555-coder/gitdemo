...
<script>
    function AddOption() {
        ...
        $('<tr class="whiteBackground">'
                + '<td width="20%" class="width20Percent col-md-4 col-12 FieldLabel col-form-label"> {template="Not_Required"} <span style="font-weight:600;">{$lang.Checkbox} ' + CurrentSize + ' {$lang.Value}:</span>&nbsp;</td>'
