<input class="FormButton SaveAddButton btn save-btn" type="button" style="width: 114px;" value="%%LNG_Subscribers_View_Button_Delete%%" onClick="ConfirmDelete('%%GLOBAL_subscriberid%%', '%%GLOBAL_list%%', %%GLOBAL_SegmentID%% )">
<script>
