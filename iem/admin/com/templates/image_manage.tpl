<script type="text/javascript">
    var ImgUrl = '%%GLOBAL_imgLocation%%';</script>
...
var iem = {
    ...
    var AdminImageManager = {
                                ...
                                GetImageRow: function() {
                                                        ...
                                                        + '  <div style="display:flex;"><label class="customCheckBox"><input type="checkbox" style="margin-top:5px;" id="deleteimages[]" value="%%image_realname%%" class="%%image_id%%_Class" /><span class="checkmark"></span></label>'
                                                        ...
                                                        + '  <input type="button" class="Field150 imgBtnNew" id="%%image_id%%_delete" value="%%LNG_DelThisImage%%" />'
                                                        + '</span>';
                                                },
                                ...
                                AddImage: function(name, url, size, displaywidth, displayheight, dimensions, id){
                                                ...
                                                $('#' + id + '_name').bind('focus', function () {
                                                        ...
                                                        this.select();
                                                        $('<div id="EditNameButtons"><input type="button" title="save" class="saveButton" name="saveEdit" onclick="saveEditName($(\'#' + this.id + '\'));" /><input type="button" title="cancel" class="cancelButton" name="cancelEdit" onclick="cancelEditName($(\'#' + this.id + '\'));" /></div>').insertAfter(this);
                                                });
                                                                ...
                                                                for (i = 0; i <= AdminImageManager.noflashTotalUploads; i++){
                                                                        ...
                                                                        $.ajaxFileUpload ({
                                                                                ...
                                                                                success: function (result) {
                                                                                                ...
                                                                                                $.post('remote.php', sendPOST, function(json){
                                                                                                        var result = $.evalJSON(json);
                                                                                                        if (result.text){
                                                        ...
                                                        $.ajax({
                                                                ...
                                                                success: function(resp){
                                                                                ...
                                                                                $('#btnUpload').bind('click', function () {
                                                                                        ...
                                                                                        buttons: '<input type="button" onclick="$.iModal.close();" style="float: left" value="%%LNG_Cancel%%"  class="SmallButton btn save-btn" /><input type="button" value="%%LNG_Upload%%"  class="SmallButton btn save-btn" id="uploadButton" style="font-weight: bold;"/>'});
                                                                                });
                                                                                $('#deleteButton').bind('click', function(){
                                                                                        ...
                                                                                        if(confirm('%%LNG_ImageManagerDeleteConfirmation%%')) {
                                                                                                ...
                                                                                                $.post('%%GLOBAL_adminUrl%%/remote.php', sendPOST, function(json){
                                                                                                        var result = $.evalJSON(json);
                                                                                                        if(result.success){
                                                                                                                for(i in result.successimages) {
                                                                                                                        var str = result.successimages[i];
...
.ui-window .buttons, #ModalButtonRow, .ModalButtonRow {
        margin-left:15px;
        margin-right:15px;
        margin-bottom:15px;
}
...
.saveButton{
background-image: url(http://localhost/interspire/iem/admin/images/Save.svg);
...
.cancelButton{
background-image: url(http://localhost/interspire/iem/admin/images/Cancel.svg);
background-repeat: no-repeat;
background-position: 50% 50%;
margin-top:2px;
height: 20px;
