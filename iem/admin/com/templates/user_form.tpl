                ...
                <div>
                    ...
                    <ul id="tabnav">
                        <li><a href="#" class="active" id="tab1" onclick="ShowTab(1);
                                SetDefaultTab(1);
                                return false;"><span>%%LNG_UserSettings_Heading%%</span></a></li>
                        <li><a href="#" id="tab2" onclick="ShowTab(2);
                                SetDefaultTab(2);
                                return false;"><span>%%LNG_UserSettingsAdvanced_Heading%%</span></a></li>
                        <li><a href="#" id="tab3" onclick="ShowTab(3);
                                SetDefaultTab(3);
                                return false;"><span>%%LNG_EmailSettings_Heading%%</span></a></li>
                        <li><a href="#" id="tab4" onclick="ShowTab(4);
                                SetDefaultTab(4);
                                return false;"><span>%%LNG_AdminNotifications_Heading%%</span></a></li>
                    </ul>
...
<script>
                            ...
                            $(function () {
                                ...
                                $('.CancelButton', document.users).click(function () {
                                    if (confirm('%%LNG_ConfirmCancel%%'))
                                        document.location.href = 'index.php?Page=Users';
                                });

                                $(document.users.usewysiwyg).click(function () {
                                    $('#sectionUseXHTML')[this.checked ? 'show' : 'hide']();
                                });
                                $(document.users.adminnotify_send_flag).click(function () {
                                    $('.sectionNotifySend')[this.checked ? 'show' : 'hide']();
                                });
                                $(document.users.adminnotify_import_flag).click(function () {
                                    $('.sectionNotifyImport')[this.checked ? 'show' : 'hide']();
                                });
    ...
    {'username': document.users.username.value,
                                ...
                                $(document.users.listadmintype).change(function () {
                                    $('#PrintLists')[this.selectedIndex == 0 ? 'hide' : 'show']();
                                });
                                $(document.users.segmentadmintype).change(function () {
                                    $('#PrintSegments')[this.selectedIndex == 0 ? 'hide' : 'show']();
                                });
                                $(document.users.templateadmintype).change(function () {
                                    $('#PrintTemplates')[this.selectedIndex == 0 ? 'hide' : 'show']();
                                });
