    ...
    <table cellspacing="0" cellpadding="0" width="100%" align="center">
        ...
        <tr>
            <td>
                ...
                <input class="FormButton" type="button" value="%%LNG_Cancel%%" onClick='if (confirm("%%LNG_Subscribers_Search_CancelPrompt%%")) {
                ...
                <table width="100%" cellspacing="0" cellpadding="2" border="0" class="PanelPlain">
                    <tr>
                        ...
                        <td valign="top" height="30">
                            <input class="FormButton" type="submit" value="%%LNG_Step2%%">
                            <input class="FormButton" type="button" value="%%LNG_Cancel%%" onClick='if (confirm("%%LNG_Subscribers_Search_CancelPrompt%%")) {
                                        document.location = "index.php?Page=Subscribers&Action=Search&SubAction=step2"
                                    }'>
                        </td>
                    </tr>
                </table>
