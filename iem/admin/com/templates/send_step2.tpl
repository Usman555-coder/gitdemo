        ...
        <tr>
            <td>
               {* <div style="padding-bottom: 10px;">
                    ...
                    <input class="FormButton" type="button" value="%%LNG_Cancel%%" onClick='if (confirm("%%LNG_Send_CancelPrompt%%")) {
                ...
                <table width="100%" cellspacing="0" cellpadding="2" border="0" class="PanelPlain">
                    <tr>
                        ...
                        <td valign="top" height="30">
                            ...
                            <input class="FormButton btn cancel-btn" type="button" value="%%LNG_Cancel%%" onClick='if (confirm("%%LNG_Send_CancelPrompt%%")) {
                                        document.location = "index.php?Page=Newsletters"
                                    }' />
                        </td>
                    </tr>
