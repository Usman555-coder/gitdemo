        ...
        {if $bounce_count > 0 || $delete_count > 0}
            <tr style="background-color:#F9F9F9;">
                <td style="border: 1px #EAEAEA solid; padding:20px;">
                    ...
                    <div>
                        <input class="FormButton btn cancel-btn ReviewButtonPage" type="button" value="{if $bounce_count > 0}{$lang.Bounce_Process_Now}{else}{$lang.Bounce_Delete_Now}{/if}" id="ProcessBounces">
