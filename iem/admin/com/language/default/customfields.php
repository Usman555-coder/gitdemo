...
define('LNG_CustomFieldTypeHelp', 'Every custom field has a particular type of data. For example, a \\\'First Name\\\' custom field will simply be a textbox. On the other hand, a \\\'Gender\\\' custom field will be radio buttons, as users will be able to select from either \\\'Male\\\' or \\\'Female\\\'. Here you will need to select the \\\'Custom Field Type\\\' that is relevant to your \\\'Custom Field\\\'.<br><br>Examples: <br><br><table border=0 cellpadding=\\\'2\\\' cellspacing=\\\'0\\\' style=\\\'width:220px\\\'><tr><td>Type</td><td>Example</td><tr><td style=\\\'width: 50%\\\'>Text:</td><td style=\\\'width:50%\\\'><input type=text style=\\\'font-family: tahoma; font-size: 10px; width:145px;\\\' value=\\\'My Name\\\'></td></tr><tr><td>Multiline Text:</td><td><textarea style=\\\'font-family: tahoma; font-size: 10px; width:145px;\\\' rows=\\\'2\\\'>My Address</textarea></td></tr><tr><td>Numbers Only:</td><td><input type text style=\\\'font-family: tahoma; font-size: 10px; width:145px;\\\' value=\\\'1800555777\\\'></td></tr><tr><td>Dropdown List:</td><td><select style=\\\'font-family: tahoma; font-size: 10px; width:145px;\\\'><option>Select Country</option></select></td></tr><tr><td>Checkboxes:</td><td style=\\\'font-family: tahoma; font-size: 10px;\\\'><input type=\\\'checkbox\\\'>Red <input type=\\\'checkbox\\\'>Blue</td></tr><tr><td>Radio Buttons:</td><td style=\\\'font-family: tahoma; font-size: 10px;\\\'><input type=\\\'radio\\\'>Male <input type=\\\'radio\\\'>Female</td></tr><tr><td>Date Field:</td><td style=\\\'font-family: tahoma; font-size:10px;\\\' nowrap><select style=\\\'font-family: tahoma; font-size:10px; width:45px\\\'><option>31</option></select><select style=\\\'font-family: tahoma; font-size:10px; width:50px\\\'><option>July</option></select><select style=\\\'font-family: tahoma; font-size:10px; width:55px\\\'><option>2010</option></select></td></tr></table>');
