...
define('LNG_Delete_Stats_Selected', 'Delete');
...
define('LNG_NoAutorespondersHaveBeenSent', 'No autoresponder statistics are available. Have you setup an autoresponder?');
define('LNG_Stats_ListStatistics', 'Contact List Statistics');
...
define('LNG_NewsletterStatistics_Snapshot_OpenStats', 'Open');
define('LNG_NewsletterStatistics_Snapshot_LinkStats', 'Link');
define('LNG_NewsletterStatistics_Snapshot_UnsubscribeStats', 'Unsubscribe');
define('LNG_NewsletterStatistics_Snapshot_ForwardStats', 'Forwarding');
...
define('LNG_AutoresponderStatistics_Snapshot_OpenStats', 'Open');
define('LNG_AutoresponderStatistics_Snapshot_LinkStats', 'Link');
define('LNG_AutoresponderStatistics_Snapshot_UnsubscribeStats', 'Unsubscribe');
define('LNG_AutoresponderStatistics_Snapshot_ForwardStats', 'Forwarding');
...
define('LNG_ListStatistics_Snapshot_OpenStats', 'Open');
...
define('LNG_ListStatistics_Snapshot_LinksStats', 'Link');
...
define('LNG_ListStatistics_Snapshot_UnsubscribeStats', 'Unsubscribe');
define('LNG_List_Summary_Graph_forwardschart', 'Forwarding Statistics');
define('LNG_ListStatistics_Snapshot_ForwardsStats', 'Forward');
define('LNG_NewsletterStatistics_Snapshot_BounceStats', 'Bounce Statistics');
...
define('LNG_ListStatistics_Snapshot_BounceStats', 'Bounce');
 ...
 * 1.3.2
 */
define('LNG_Bounce_Rule_unknown', 'Unknown');
 ...
 * 1.4.0
 */
define('LNG_Export_Stats_Selected','Export');
...
define('LNG_PrintAutoresponderStatistics','Print Autoresponder Statistics');
define('LNG_SelectStatisticsToPrint','Please choose which statistics you would like to print');
define('LNG_Stats_Clickthrough','Click-through Rate');
...
define('LNG_NewsletterStatistics_Snapshot_Summary', 'A summary of the performance for the selected email campaign is shown below:');
 ...
 * 1.4.1
 */
define('LNG_Stats_TotalOpens_Description', 'Total number of opens recorded against this email (including multiple opens)');
define('LNG_Stats_TotalUniqueOpens_Description', 'Unique Opens only records the number of opens once for each email in this campaign');
...
define('LNG_ListStatsTotalConfirms', 'Total Confirmed Contacts: ');
define('LNG_UnconfirmsCount', 'Unconfirmed Contacts');
define('LNG_ConfirmsCount', 'Confirmed Contacts');
...
define('LNG_AutoresponderStatistics_SubscriberInformation_Intro', 'View which contacts were sent the autoresponder \'%s\'');
...
define('LNG_Stats_TotalLists', 'Contact Lists');
...
define('LNG_SentToLists', 'Contact Lists');
define('LNG_SentToList', 'Contact List');
