 ...
 * 1.3.0
 */
define('LNG_TemplatesManage', 'View Custom Email Templates');
define('LNG_Help_TemplatesManage_Create', ' To create a new template, click on the "Create a Custom Template" button below.');
define('LNG_CreateTemplate', 'Create a Custom Email Template');
define('LNG_CreateTemplateButton', 'Create a Custom Template...');
...
define('LNG_Help_TemplatesManageBuiltIn', 'All available built-in email templates are shown below. To use a template, simply select it when creating an email campaign.');
